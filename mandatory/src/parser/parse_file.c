...
/*   Updated: 2023/08/29 11:16:55 by ssalmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_scene *scene)
{
	...
	if (scene->n_cameras > 1)
		return (return_err("More than one camera elem given in file", NULL));
	if (scene->n_lights > 1)
		return (return_err("More than one light elem given in file", NULL));
