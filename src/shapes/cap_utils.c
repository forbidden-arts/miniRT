...
/*   Updated: 2023/08/21 17:40:54 by ssalmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ray.h"

t_v3d	get_top_cap(t_object *object)
{
	t_v3d	displacement;
...
t_v3d	get_bottom_cap(t_object *object)
{
	t_v3d	displacement;
...
void	set_cap_values(t_object *object,
					t_object *cap,
					BOOL is_bottom)
{
	t_v3d	displacement;
...
BOOL	is_point_closer_to_top_cap(t_object *object,
									t_v3d *point,
									t_v3d *cap_center)
{
